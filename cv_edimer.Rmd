...
Zootecnista y especialista en Estadística, con capacidad de utilizar métodos estadísticos para la resolución de problemas en múltiples áreas del conocimiento. Tengo experiencia en docencia universitaria, formulación de proyectos de investigación y consultoría estadística. Me dedico a extraer conocimiento de los datos mediante la implementación de técnicas de aprendizaje automático, utilizando lenguajes de programación como *R* y *Python*. Participante activo en competencias de *Ciencia de Datos* a través de plataformas como [Kaggle](https://www.kaggle.com/), [Zindi (África)](https://zindi.africa/) y [DataSource (Latinoamérica)](https://www.datasource.ai/). 
</div>
