...
- Desarrollo de productos de datos con R y Python (dashboard, Apps, reportes automáticos).

- Construcción de modelos de machine learning e intergración en aplicativos web (Shiny Apps). 

- Desarrollo de productos de *Inteligencia Artificial* (ChatBots, Agentes de IA).

- Operacionalización (MLOps) de modelos de machine learning en la nube.
...
Soy Zootecnista y especialista en Estadística, con sólida formación en la aplicación de métodos estadísticos y técnicas de inteligencia artificial para la resolución de problemas en diversas áreas del conocimiento. Tengo experiencia en docencia universitaria, formulación de proyectos de investigación y consultoría estadística. Soy hábil en la extracción de conocimiento a partir de datos mediante la implementación de técnicas de aprendizaje automático e inteligencia artificial, utilizando lenguajes de programación como R y Python. Soy participante activo en competencias de Ciencia de Datos a través de plataformas como [Kaggle](https://www.kaggle.com/), [Zindi (África)](https://zindi.africa/) y [DataSource (Latinoamérica)](https://www.datasource.ai/). 
</div>
