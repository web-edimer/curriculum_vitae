...
- Desarrollo de productos de datos con R (dashboard, Apps, informes automáticos).

- Construcción de modelos de machine learning y ensamblaje en aplicativos web (Shiny Apps). 
