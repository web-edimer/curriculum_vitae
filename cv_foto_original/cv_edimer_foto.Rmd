...
- Construcción de modelos de machine learning e integración en aplicativos web (Shiny Apps). 

- Experiencia en diseño y análisis estadístico de experimentos en el sector agrario.

- Consultoría estadística aplicada en evaluaciones agronómicas, pruebas microbiológicas en calidad de carne, bienestar animal, comportamiento animal, entre otras.
...
Bogotá, Colombia (modalidad virtual)
